            ...
            <Dropdown>
                ...
                <template v-slot:content>
                    <ul class="bg-gray-300 py-0">
                        <li class="p-3 hover:bg-gray-500 transition-all cursor-pointer hover:text-white flex gap-1">
                            <Link class="flex gap-1" :href="`/proyectos/edit/${project.id}`">
                        ...
                        <li @click="deleteProject(project.id)" class="p-3 hover:bg-gray-500 transition-all cursor-pointer hover:text-white flex gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
